...
VALUES
    (1, 'Deposit', 1000.00, '2023-01-01 12:00:00'),
    (2, 'Withdrawal', 500.50, '2023-02-15 14:30:00'),
    (3, 'Transfer', 200.25, '2023-12-05 09:45:00'),
    (4, 'Deposit', 750.75, '2023-03-20 18:20:00'),
    (5, 'Withdrawal', 300.00, '2023-11-10 08:15:00'),
    (6, 'Transfer', 150.50, '2023-05-25 16:30:00'),
    (7, 'Deposit', 1200.00, '2023-07-12 10:45:00'),
    (8, 'Withdrawal', 450.25, '2023-08-18 14:30:00'),
    (9, 'Deposit', 800.50, '2023-04-05 09:00:00'),
    (10, 'Transfer', 600.00, '2023-06-30 11:30:00'),
    (11, 'Deposit', 950.25, '2023-09-15 13:45:00'),
    (12, 'Withdrawal', 200.75, '2023-10-22 17:00:00'),
    (13, 'Transfer', 300.25, '2023-11-05 14:00:00'),
    (14, 'Deposit', 550.50, '2023-12-20 16:30:00'),
    (15, 'Withdrawal', 150.75, '2023-02-01 09:15:00'),
    (16, 'Transfer', 700.00, '2023-03-15 11:30:00'),
    (17, 'Deposit', 250.25, '2023-04-10 14:45:00'),
    (18, 'Withdrawal', 400.50, '2023-05-25 17:00:00'),
    (19, 'Deposit', 800.75, '2023-06-30 10:30:00'),
    (20, 'Transfer', 1000.00, '2023-08-15 13:45:00'),
    (21, 'Deposit', 300.50, '2023-09-20 16:00:00'),
    (22, 'Withdrawal', 650.25, '2023-10-05 19:15:00'),
    (23, 'Deposit', 600.25, '2023-11-10 14:30:00'),
    (24, 'Withdrawal', 200.50, '2023-12-25 17:45:00'),
    (25, 'Transfer', 450.75, '2023-02-05 09:00:00'),
    (26, 'Deposit', 850.00, '2023-03-20 11:15:00'),
    (27, 'Withdrawal', 300.25, '2023-04-15 14:30:00'),
    (28, 'Deposit', 700.50, '2023-05-30 16:45:00'),
    (29, 'Transfer', 150.75, '2023-07-10 09:00:00'),
    (30, 'Deposit', 500.00, '2023-08-25 11:15:00'),
    (31, 'Withdrawal', 350.25, '2023-09-10 14:30:00'),
    (32, 'Deposit', 200.50, '2023-10-15 16:45:00'),
    (33, 'Transfer', 600.25, '2023-11-10 14:30:00'),
    (34, 'Deposit', 200.50, '2023-12-25 17:45:00'),
    (35, 'Withdrawal', 450.75, '2023-02-05 09:00:00'),
    (36, 'Transfer', 850.00, '2023-03-20 11:15:00'),
    (37, 'Deposit', 300.25, '2023-04-15 14:30:00'),
    (38, 'Withdrawal', 700.50, '2023-05-30 16:45:00'),
    (39, 'Deposit', 150.75, '2023-07-10 09:00:00'),
    (40, 'Transfer', 500.00, '2023-08-25 11:15:00'),
    (41, 'Withdrawal', 350.25, '2023-09-10 14:30:00'),
    (42, 'Deposit', 200.50, '2023-10-15 16:45:00'),
    (43, 'Deposit', 600.25, '2023-11-10 14:30:00'),
    (44, 'Withdrawal', 200.50, '2023-12-25 17:45:00'),
    (45, 'Transfer', 450.75, '2023-02-05 09:00:00'),
    (46, 'Transfer', 850.00, '2023-03-20 11:15:00'),
    (47, 'Withdrawal', 300.25, '2023-04-15 14:30:00'),
    (48, 'Deposit', 700.50, '2023-05-30 16:45:00'),
    (49, 'Withdrawal', 150.75, '2023-07-10 09:00:00'),
    (50, 'Deposit', 500.00, '2023-08-25 11:15:00'),
    (51, 'Transfer', 350.25, '2023-09-10 14:30:00'),
    (52, 'Withdrawal', 200.50, '2023-10-15 16:45:00'),
    (53, 'Deposit', 400.75, '2023-11-10 09:00:00'),
    (54, 'Transfer', 700.00, '2023-12-25 11:15:00'),
    (55, 'Deposit', 250.25, '2023-02-15 14:30:00'),
    (56, 'Withdrawal', 400.50, '2023-03-30 16:45:00'),
    (57, 'Deposit', 800.75, '2023-04-10 09:00:00'),
    (58, 'Transfer', 1000.00, '2023-05-25 11:15:00'),
    (59, 'Withdrawal', 300.25, '2023-06-10 14:30:00'),
    (60, 'Deposit', 200.50, '2023-07-15 16:45:00'),
    (61, 'Transfer', 600.25, '2023-10-10 14:30:00'),
    (62, 'Deposit', 200.50, '2023-11-25 17:45:00'),
    (63, 'Withdrawal', 450.75, '2023-01-05 09:00:00'),
    (64, 'Transfer', 850.00, '2023-02-20 11:15:00'),
    (65, 'Withdrawal', 300.25, '2023-03-15 14:30:00'),
    (66, 'Deposit', 700.50, '2023-04-30 16:45:00'),
    (67, 'Withdrawal', 150.75, '2023-06-10 09:00:00'),
    (68, 'Deposit', 500.00, '2023-07-25 11:15:00'),
    (69, 'Transfer', 350.25, '2023-08-10 14:30:00'),
    (70, 'Withdrawal', 200.50, '2023-09-15 16:45:00'),
    (71, 'Deposit', 400.75, '2023-10-10 09:00:00'),
    (72, 'Transfer', 700.00, '2023-11-25 11:15:00'),
    (73, 'Deposit', 250.25, '2023-01-15 14:30:00'),
    (74, 'Withdrawal', 400.50, '2023-02-28 16:45:00'),
    (75, 'Deposit', 800.75, '2023-04-10 09:00:00'),
    (76, 'Transfer', 1000.00, '2023-05-25 11:15:00'),
    (77, 'Withdrawal', 300.25, '2023-06-10 14:30:00'),
    (78, 'Deposit', 200.50, '2023-07-15 16:45:00'),
    (79, 'Transfer', 600.25, '2023-10-10 14:30:00'),
    (80, 'Deposit', 200.50, '2023-11-25 17:45:00'),
    (81, 'Withdrawal', 450.75, '2023-01-05 09:00:00'),
    (82, 'Transfer', 850.00, '2023-02-20 11:15:00'),
    (83, 'Withdrawal', 300.25, '2023-03-15 14:30:00'),
    (84, 'Deposit', 700.50, '2023-04-30 16:45:00'),
    (85, 'Withdrawal', 150.75, '2023-06-10 09:00:00'),
    (86, 'Deposit', 500.00, '2023-07-25 11:15:00'),
    (87, 'Transfer', 350.25, '2023-08-10 14:30:00'),
    (88, 'Withdrawal', 200.50, '2023-09-15 16:45:00'),
    (89, 'Deposit', 400.75, '2023-10-10 09:00:00'),
    (90, 'Transfer', 700.00, '2023-11-25 11:15:00'),
    (91, 'Deposit', 250.25, '2023-01-15 14:30:00'),
    (92, 'Withdrawal', 400.50, '2023-02-28 16:45:00'),
    (93, 'Deposit', 800.75, '2023-04-10 09:00:00'),
    (94, 'Transfer', 1000.00, '2023-05-25 11:15:00'),
    (95, 'Withdrawal', 300.25, '2023-06-10 14:30:00'),
    (96, 'Deposit', 200.50, '2023-07-15 16:45:00'),
    (97, 'Transfer', 600.25, '2023-08-10 14:30:00'),
    (98, 'Withdrawal', 200.50, '2023-09-15 16:45:00'),
    (99, 'Deposit', 400.75, '2023-10-10 09:00:00'),
    (100, 'Transfer', 700.00, '2023-11-25 11:15:00');
